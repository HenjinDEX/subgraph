...
const WETH_ADDRESS = '0x4539fb30977a7de928631f16c45354ba6fdbb9bf'
const USDC_WETH_POOL = '0x23d2b6def3b22606b29c9cc098920866024d49d2'

// token where amounts should contribute to tracked volume and liquidity
// usually tokens that many tokens are paired with s
export let WHITELIST_TOKENS: string[] = [
  '0x5afcbf3f53eaa3a31c972a058a87e4182b746f44', // USDC
  '0x5288ff7d632a85bcc0f214e6c49f3c2e863cfec6', // USDT
  '0x4539fb30977a7de928631f16c45354ba6fdbb9bf', // WETH
]
...
export function getEthPriceInUSD(): BigDecimal {
  let usdcPool = Pool.load(USDC_WETH_POOL) // dai is token0
  if (usdcPool !== null) {
    // return usdcPool.token0Price
    return usdcPool.token0 == STABLE_COINS[0] ? usdcPool.token0Price : usdcPool.token1Price
  } else {
    return ZERO_BD
  }
} 
